...
async def qwen_login(request: Request):
    ...
    We redirect to the English documentation page to assist international users.
    """
    return RedirectResponse(url="https://help.aliyun.com/document_detail/611472.html?spm=a2c4g.11186623.0.0.1f456041aBYW1d")
